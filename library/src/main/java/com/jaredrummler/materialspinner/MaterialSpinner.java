...
public class MaterialSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            popupWindowMaxWidth = ta.getDimensionPixelSize(R.styleable.MaterialSpinner_ms_dropdown_max_width, 0);
     ...
     */
    public void setDropdownMaxWidth(int width) {
        popupWindowMaxWidth = width;
        popupWindow.setWidth(calculatePopupWindowWidth());
    }
    ...
    private int calculatePopupWindowWidth() {
        ...
        if (popupWindowMaxWidth > 0 && listViewWidth > popupWindowMaxWidth) {
            return popupWindowMaxWidth;
                ...
                && popupWindowWidth <= listViewWidth) {
            return popupWindowWidth;
        } else if (listViewWidth == 0 && adapter.getItems().size() == 1) {
            return (int) itemWidth;
        }
        return (int) listViewWidth;
    }
