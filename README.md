...
<p align="center">
  ...
  <a target="_blank" href="http://www.methodscount.com/?lib=com.jaredrummler%3Amaterial-spinner%3A1.2.5"><img src="https://img.shields.io/badge/methods-197-e91e63.svg" /></a>
...
Download [the latest AAR](https://repo1.maven.org/maven2/com/jaredrummler/material-spinner/1.2.5/material-spinner-1.2.5.aar) or grab via Gradle:

```groovy
compile 'com.github.neccy:MaterialSpinnerAh:v1.0.2'
```
or Maven:
```xml
<dependency>
